		...
		<div class="col-md-3 no-padding">
			<a href="<?php echo get_home_url(); ?>/contact">
				<div class="contact-us h-100">
					<h2 class="text-uppercase h5 font-weight-bold pb-3">Contact Us</h2>
					<p>Get involved, ask questions, and learn more about Delaware Thoroughbred Horsemen's Association.</p>
					<p><i class="fas fa-arrow-right fa-2x"></i></p>
				</div>
			</a>
		</div>
