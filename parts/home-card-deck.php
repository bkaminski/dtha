	...
	<div class="container pt-5 pb-5">
		<div class="card-deck">
			...
			<div class="card rounded-0">
				...
				<div class="card-body">
					<h5 class="text-uppercase text-green font-weight-bold"><?php the_field('card_2_title'); ?></h5>
			...
			<div class="card rounded-0">
				...
				<div class="card-body">
					<h5 class="text-uppercase text-green font-weight-bold"><?php the_field('card_3_title'); ?></h5>
